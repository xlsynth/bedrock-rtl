...
rule_verilog_elab_test(<a href="#rule_verilog_elab_test-name">name</a>, <a href="#rule_verilog_elab_test-deps">deps</a>, <a href="#rule_verilog_elab_test-compile_only">compile_only</a>, <a href="#rule_verilog_elab_test-custom_control_body">custom_control_body</a>, <a href="#rule_verilog_elab_test-custom_control_header">custom_control_header</a>,
                       <a href="#rule_verilog_elab_test-custom_tcl_body">custom_tcl_body</a>, <a href="#rule_verilog_elab_test-custom_tcl_header">custom_tcl_header</a>, <a href="#rule_verilog_elab_test-defines">defines</a>, <a href="#rule_verilog_elab_test-opts">opts</a>, <a href="#rule_verilog_elab_test-params">params</a>, <a href="#rule_verilog_elab_test-runner_flags">runner_flags</a>, <a href="#rule_verilog_elab_test-tool">tool</a>,
                       <a href="#rule_verilog_elab_test-top">top</a>, <a href="#rule_verilog_elab_test-verilog_runner_data">verilog_runner_data</a>, <a href="#rule_verilog_elab_test-verilog_runner_env">verilog_runner_env</a>, <a href="#rule_verilog_elab_test-verilog_runner_plugins">verilog_runner_plugins</a>,
...
| <a id="rule_verilog_elab_test-custom_control_body"></a>custom_control_body |  Tool-neutral custom body fragment. Tcl-based tools may use the equivalent custom_tcl_body alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_elab_test-custom_control_header"></a>custom_control_header |  Tool-neutral custom header fragment. Tcl-based tools may use the equivalent custom_tcl_header alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_elab_test-custom_tcl_body"></a>custom_tcl_body |  Tcl-specific alias for custom_control_body.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_elab_test-custom_tcl_header"></a>custom_tcl_header |  Tcl-specific alias for custom_control_header.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
rule_verilog_fpv_sandbox(<a href="#rule_verilog_fpv_sandbox-name">name</a>, <a href="#rule_verilog_fpv_sandbox-deps">deps</a>, <a href="#rule_verilog_fpv_sandbox-data">data</a>, <a href="#rule_verilog_fpv_sandbox-analysis_opts">analysis_opts</a>, <a href="#rule_verilog_fpv_sandbox-conn">conn</a>, <a href="#rule_verilog_fpv_sandbox-custom_control_body">custom_control_body</a>,
                         <a href="#rule_verilog_fpv_sandbox-custom_control_header">custom_control_header</a>, <a href="#rule_verilog_fpv_sandbox-custom_tcl_body">custom_tcl_body</a>, <a href="#rule_verilog_fpv_sandbox-custom_tcl_header">custom_tcl_header</a>, <a href="#rule_verilog_fpv_sandbox-defines">defines</a>,
...
| <a id="rule_verilog_fpv_sandbox-conn"></a>conn |  Request connectivity mode. Not all formal plugins support this mode.   | Boolean | optional |  `False`  |
| <a id="rule_verilog_fpv_sandbox-custom_control_body"></a>custom_control_body |  Tool-neutral custom body fragment. Tcl-based tools may use the equivalent custom_tcl_body alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_fpv_sandbox-custom_control_header"></a>custom_control_header |  Tool-neutral custom header fragment. Tcl-based tools may use the equivalent custom_tcl_header alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_fpv_sandbox-custom_tcl_body"></a>custom_tcl_body |  Tcl-specific alias for custom_control_body.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_fpv_sandbox-custom_tcl_header"></a>custom_tcl_header |  Tcl-specific alias for custom_control_header.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
| <a id="rule_verilog_fpv_sandbox-gui"></a>gui |  Request GUI mode. Not all formal plugins support this mode.   | Boolean | optional |  `False`  |
| <a id="rule_verilog_fpv_sandbox-opts"></a>opts |  Legacy plugin-specific options not covered by other arguments. Their meaning is defined by the selected plugin.   | List of strings | optional |  `[]`  |
...
| <a id="rule_verilog_fpv_sandbox-runner_flags"></a>runner_flags |  Command-line flags forwarded to Verilog Runner.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `"@bedrock-rtl//bazel:runner_flags"`  |
...
rule_verilog_fpv_test(<a href="#rule_verilog_fpv_test-name">name</a>, <a href="#rule_verilog_fpv_test-deps">deps</a>, <a href="#rule_verilog_fpv_test-data">data</a>, <a href="#rule_verilog_fpv_test-analysis_opts">analysis_opts</a>, <a href="#rule_verilog_fpv_test-conn">conn</a>, <a href="#rule_verilog_fpv_test-custom_control_body">custom_control_body</a>,
                      <a href="#rule_verilog_fpv_test-custom_control_header">custom_control_header</a>, <a href="#rule_verilog_fpv_test-custom_tcl_body">custom_tcl_body</a>, <a href="#rule_verilog_fpv_test-custom_tcl_header">custom_tcl_header</a>, <a href="#rule_verilog_fpv_test-defines">defines</a>, <a href="#rule_verilog_fpv_test-elab_only">elab_only</a>,
                      <a href="#rule_verilog_fpv_test-elab_opts">elab_opts</a>, <a href="#rule_verilog_fpv_test-gui">gui</a>, <a href="#rule_verilog_fpv_test-opts">opts</a>, <a href="#rule_verilog_fpv_test-params">params</a>, <a href="#rule_verilog_fpv_test-runner_flags">runner_flags</a>, <a href="#rule_verilog_fpv_test-tool">tool</a>, <a href="#rule_verilog_fpv_test-top">top</a>, <a href="#rule_verilog_fpv_test-verilog_runner_data">verilog_runner_data</a>,
                      <a href="#rule_verilog_fpv_test-verilog_runner_env">verilog_runner_env</a>, <a href="#rule_verilog_fpv_test-verilog_runner_plugins">verilog_runner_plugins</a>, <a href="#rule_verilog_fpv_test-verilog_runner_tool">verilog_runner_tool</a>)
</pre>
...
| <a id="rule_verilog_fpv_test-conn"></a>conn |  Request connectivity mode. Not all formal plugins support this mode.   | Boolean | optional |  `False`  |
| <a id="rule_verilog_fpv_test-custom_control_body"></a>custom_control_body |  Tool-neutral custom body fragment. Tcl-based tools may use the equivalent custom_tcl_body alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_fpv_test-custom_control_header"></a>custom_control_header |  Tool-neutral custom header fragment. Tcl-based tools may use the equivalent custom_tcl_header alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_fpv_test-custom_tcl_body"></a>custom_tcl_body |  Tcl-specific alias for custom_control_body.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_fpv_test-custom_tcl_header"></a>custom_tcl_header |  Tcl-specific alias for custom_control_header.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
| <a id="rule_verilog_fpv_test-gui"></a>gui |  Request GUI mode. Not all formal plugins support this mode.   | Boolean | optional |  `False`  |
| <a id="rule_verilog_fpv_test-opts"></a>opts |  Legacy plugin-specific options not covered by other arguments. Their meaning is defined by the selected plugin.   | List of strings | optional |  `[]`  |
...
| <a id="rule_verilog_fpv_test-runner_flags"></a>runner_flags |  Command-line flags forwarded to Verilog Runner.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `"@bedrock-rtl//bazel:runner_flags"`  |
...
rule_verilog_lint_test(<a href="#rule_verilog_lint_test-name">name</a>, <a href="#rule_verilog_lint_test-deps">deps</a>, <a href="#rule_verilog_lint_test-custom_control_body">custom_control_body</a>, <a href="#rule_verilog_lint_test-custom_control_header">custom_control_header</a>, <a href="#rule_verilog_lint_test-custom_tcl_body">custom_tcl_body</a>,
                       <a href="#rule_verilog_lint_test-custom_tcl_header">custom_tcl_header</a>, <a href="#rule_verilog_lint_test-defines">defines</a>, <a href="#rule_verilog_lint_test-params">params</a>, <a href="#rule_verilog_lint_test-policy">policy</a>, <a href="#rule_verilog_lint_test-runner_flags">runner_flags</a>, <a href="#rule_verilog_lint_test-tool">tool</a>, <a href="#rule_verilog_lint_test-top">top</a>,
                       <a href="#rule_verilog_lint_test-verilog_runner_data">verilog_runner_data</a>, <a href="#rule_verilog_lint_test-verilog_runner_env">verilog_runner_env</a>, <a href="#rule_verilog_lint_test-verilog_runner_plugins">verilog_runner_plugins</a>,
...
| <a id="rule_verilog_lint_test-custom_control_body"></a>custom_control_body |  Tool-neutral custom body fragment. Tcl-based tools may use the equivalent custom_tcl_body alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_lint_test-custom_control_header"></a>custom_control_header |  Tool-neutral custom header fragment. Tcl-based tools may use the equivalent custom_tcl_header alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_lint_test-custom_tcl_body"></a>custom_tcl_body |  Tcl-specific alias for custom_control_body.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_lint_test-custom_tcl_header"></a>custom_tcl_header |  Tcl-specific alias for custom_control_header.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
rule_verilog_sim_test(<a href="#rule_verilog_sim_test-name">name</a>, <a href="#rule_verilog_sim_test-deps">deps</a>, <a href="#rule_verilog_sim_test-custom_control_body">custom_control_body</a>, <a href="#rule_verilog_sim_test-custom_control_header">custom_control_header</a>, <a href="#rule_verilog_sim_test-custom_tcl_body">custom_tcl_body</a>,
                      <a href="#rule_verilog_sim_test-custom_tcl_header">custom_tcl_header</a>, <a href="#rule_verilog_sim_test-defines">defines</a>, <a href="#rule_verilog_sim_test-elab_only">elab_only</a>, <a href="#rule_verilog_sim_test-elab_opts">elab_opts</a>, <a href="#rule_verilog_sim_test-opts">opts</a>, <a href="#rule_verilog_sim_test-params">params</a>, <a href="#rule_verilog_sim_test-runner_flags">runner_flags</a>,
                      <a href="#rule_verilog_sim_test-seed">seed</a>, <a href="#rule_verilog_sim_test-sim_opts">sim_opts</a>, <a href="#rule_verilog_sim_test-tool">tool</a>, <a href="#rule_verilog_sim_test-top">top</a>, <a href="#rule_verilog_sim_test-uvm">uvm</a>, <a href="#rule_verilog_sim_test-verilog_runner_data">verilog_runner_data</a>, <a href="#rule_verilog_sim_test-verilog_runner_env">verilog_runner_env</a>,
...
| <a id="rule_verilog_sim_test-custom_control_body"></a>custom_control_body |  Tool-neutral custom body fragment. Tcl-based tools may use the equivalent custom_tcl_body alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_sim_test-custom_control_header"></a>custom_control_header |  Tool-neutral custom header fragment. Tcl-based tools may use the equivalent custom_tcl_header alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_sim_test-custom_tcl_body"></a>custom_tcl_body |  Tcl-specific alias for custom_control_body.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_sim_test-custom_tcl_header"></a>custom_tcl_header |  Tcl-specific alias for custom_control_header.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
rule_verilog_synth(<a href="#rule_verilog_synth-name">name</a>, <a href="#rule_verilog_synth-deps">deps</a>, <a href="#rule_verilog_synth-data">data</a>, <a href="#rule_verilog_synth-clock_period_ps">clock_period_ps</a>, <a href="#rule_verilog_synth-custom_control_body">custom_control_body</a>, <a href="#rule_verilog_synth-custom_control_header">custom_control_header</a>,
                   <a href="#rule_verilog_synth-custom_tcl_body">custom_tcl_body</a>, <a href="#rule_verilog_synth-custom_tcl_header">custom_tcl_header</a>, <a href="#rule_verilog_synth-defines">defines</a>, <a href="#rule_verilog_synth-liberty">liberty</a>, <a href="#rule_verilog_synth-opts">opts</a>, <a href="#rule_verilog_synth-params">params</a>, <a href="#rule_verilog_synth-runner_flags">runner_flags</a>,
                   <a href="#rule_verilog_synth-tool">tool</a>, <a href="#rule_verilog_synth-top">top</a>, <a href="#rule_verilog_synth-verilog_runner_data">verilog_runner_data</a>, <a href="#rule_verilog_synth-verilog_runner_env">verilog_runner_env</a>, <a href="#rule_verilog_synth-verilog_runner_plugins">verilog_runner_plugins</a>,
                   <a href="#rule_verilog_synth-verilog_runner_tool">verilog_runner_tool</a>)
</pre>
...
| <a id="rule_verilog_synth-custom_control_body"></a>custom_control_body |  Tool-neutral custom body fragment. Tcl-based tools may use the equivalent custom_tcl_body alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_synth-custom_control_header"></a>custom_control_header |  Tool-neutral custom header fragment. Tcl-based tools may use the equivalent custom_tcl_header alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_synth-custom_tcl_body"></a>custom_tcl_body |  Tcl-specific alias for custom_control_body.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_synth-custom_tcl_header"></a>custom_tcl_header |  Tcl-specific alias for custom_control_header.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
rule_verilog_synth_sandbox(<a href="#rule_verilog_synth_sandbox-name">name</a>, <a href="#rule_verilog_synth_sandbox-deps">deps</a>, <a href="#rule_verilog_synth_sandbox-data">data</a>, <a href="#rule_verilog_synth_sandbox-clock_period_ps">clock_period_ps</a>, <a href="#rule_verilog_synth_sandbox-custom_control_body">custom_control_body</a>,
                           <a href="#rule_verilog_synth_sandbox-custom_control_header">custom_control_header</a>, <a href="#rule_verilog_synth_sandbox-custom_tcl_body">custom_tcl_body</a>, <a href="#rule_verilog_synth_sandbox-custom_tcl_header">custom_tcl_header</a>, <a href="#rule_verilog_synth_sandbox-defines">defines</a>,
                           <a href="#rule_verilog_synth_sandbox-liberty">liberty</a>, <a href="#rule_verilog_synth_sandbox-opts">opts</a>, <a href="#rule_verilog_synth_sandbox-params">params</a>, <a href="#rule_verilog_synth_sandbox-runner_flags">runner_flags</a>, <a href="#rule_verilog_synth_sandbox-tool">tool</a>, <a href="#rule_verilog_synth_sandbox-top">top</a>, <a href="#rule_verilog_synth_sandbox-verilog_runner_data">verilog_runner_data</a>,
                           <a href="#rule_verilog_synth_sandbox-verilog_runner_env">verilog_runner_env</a>, <a href="#rule_verilog_synth_sandbox-verilog_runner_plugins">verilog_runner_plugins</a>, <a href="#rule_verilog_synth_sandbox-verilog_runner_tool">verilog_runner_tool</a>)
</pre>
...
| <a id="rule_verilog_synth_sandbox-custom_control_body"></a>custom_control_body |  Tool-neutral custom body fragment. Tcl-based tools may use the equivalent custom_tcl_body alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_synth_sandbox-custom_control_header"></a>custom_control_header |  Tool-neutral custom header fragment. Tcl-based tools may use the equivalent custom_tcl_header alias.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_synth_sandbox-custom_tcl_body"></a>custom_tcl_body |  Tcl-specific alias for custom_control_body.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="rule_verilog_synth_sandbox-custom_tcl_header"></a>custom_tcl_header |  Tcl-specific alias for custom_control_header.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
