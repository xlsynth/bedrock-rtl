...
def br_verilog_fpv_test_suite(name, **kwargs):
    ...
    * Defines `BR_ASSERT_ON`, `BR_ENABLE_IMPL_CHECKS`, `BR_ENABLE_FPV` and `BR_DISABLE_FINAL_CHECKS`.
    ...
    verilog_fpv_test_suite(
        name = name,
        defines = ["BR_ASSERT_ON", "BR_ENABLE_IMPL_CHECKS", "BR_ENABLE_FPV", "BR_DISABLE_FINAL_CHECKS"],
        **kwargs
    )
