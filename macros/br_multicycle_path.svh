...
`define BR_MCP_NAMED(__cycles__, __name__, __in__, __out__) \
...
`define BR_RESET_ONLY_MCP_NAMED(__cycles__, __name__, __in__, __out__) \
br_misc_multicycle_path #( \
    .Cycles(__cycles__), \
    .Width($bits(__out__)), \
...
`define BR_MCP(__cycles__, __in__, __out__) `BR_MCP_NAMED(__cycles__, __out__, __in__, __out__)
`define BR_RESET_ONLY_MCP(__cycles__, __in__, __out__) \
`BR_RESET_ONLY_MCP_NAMED(__cycles__, __out__, __in__, __out__)
