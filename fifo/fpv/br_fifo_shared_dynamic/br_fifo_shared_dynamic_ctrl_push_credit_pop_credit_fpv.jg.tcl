...
assume -name no_push_in_reset {
  (rst || push_sender_in_reset || pop_receiver_in_reset || push_receiver_in_reset) |-> push_valid == '0}
assume -name no_pop_credit_in_reset {
  (rst || push_sender_in_reset || pop_receiver_in_reset) |-> pop_credit == '0}
...
# External RAMs flush their response-valid pipelines during any reset.
assume -name no_data_ram_response_in_reset {
  (rst || push_sender_in_reset || pop_receiver_in_reset) |-> data_ram_rd_data_valid == '0}
assume -name no_pointer_ram_response_in_reset {
  (rst || push_sender_in_reset || pop_receiver_in_reset) |-> ptr_ram_rd_data_valid == '0}

assert -name pop_valid_zero_in_reset {
  (rst || push_sender_in_reset || pop_receiver_in_reset) |-> pop_valid == '0}
