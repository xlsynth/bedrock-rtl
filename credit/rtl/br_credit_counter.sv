...
// entire module by asserting the reinit signal. During reinit, there must be no
// increment and decrement ready will be blocked.
...
`endif  // BR_ASSERT_ON
  ...
  `BR_ASSERT_INTG(no_incr_during_reinit_a, reinit |-> !incr_valid)
