...
module br_amba_axi_shrinker_tb;
  ...
  initial begin
    ...
    $display("Checking halfword-sized shrinking write transaction");
    fork
      send_wide_aw(12'h122, 2'b01, 8'h01, 3'd1, 3'b010, 1'b1);
      expect_narrow_aw(12'h122, 2'b01, 8'h03, 3'd0, 3'b010, 1'b1);
    join

    fork
      begin
        send_wide_w(32'h44332211, 4'b1100, 1'b0, 1'b1);
        send_wide_w(32'h44332211, 4'b1100, 1'b1, 1'b1);
      end
      begin
        expect_narrow_w(8'h33, 1'b1, 1'b0, 1'b1);
        expect_narrow_w(8'h44, 1'b1, 1'b0, 1'b1);
        expect_narrow_w(8'h11, 1'b0, 1'b0, 1'b1);
        expect_narrow_w(8'h22, 1'b0, 1'b1, 1'b1);
      end
    join

    fork
      send_narrow_b(2'b01, AxiRespExOkay, 1'b1);
      expect_wide_b(2'b01, AxiRespExOkay, 1'b1);
    join

    $display("Checking multi-beat write transaction that is not narrowed");
    fork
      send_wide_aw(12'h121, 2'b11, 8'h01, 3'd0, 3'b111, 1'b0);
      expect_narrow_aw(12'h121, 2'b11, 8'h01, 3'd0, 3'b111, 1'b0);
    join

    fork
      begin
        send_wide_w(32'h44332211, 4'b0010, 1'b0, 1'b0);
        send_wide_w(32'hCCBBAA99, 4'b0100, 1'b1, 1'b0);
      end
      begin
        expect_narrow_w(8'h22, 1'b1, 1'b0, 1'b0);
        expect_narrow_w(8'hBB, 1'b1, 1'b1, 1'b0);
      end
    join

    fork
      send_narrow_b(2'b11, AxiRespOkay, 1'b0);
      expect_wide_b(2'b11, AxiRespOkay, 1'b0);
    join

    $display("Checking multiple write transactions inflight");

    fork
      begin
        send_wide_aw(12'h120, 2'b00, 8'h01, 3'd0, 3'b111, 1'b0);
        send_wide_aw(12'h122, 2'b01, 8'h00, 3'd1, 3'b111, 1'b0);
      end
      begin
        expect_narrow_aw(12'h120, 2'b00, 8'h01, 3'd0, 3'b111, 1'b0);
        expect_narrow_aw(12'h122, 2'b01, 8'h01, 3'd0, 3'b111, 1'b0);
      end
    join

    fork
      begin
        send_wide_w(32'h44332211, 4'b0001, 1'b0, 1'b0);
        send_wide_w(32'h88776655, 4'b0010, 1'b1, 1'b0);
        send_wide_w(32'hCCBBAA99, 4'b1100, 1'b1, 1'b0);
      end
      begin
        expect_narrow_w(8'h11, 1'b1, 1'b0, 1'b0);
        expect_narrow_w(8'h66, 1'b1, 1'b1, 1'b0);
        expect_narrow_w(8'hBB, 1'b1, 1'b0, 1'b0);
        expect_narrow_w(8'hCC, 1'b1, 1'b1, 1'b0);
      end
    join

    fork
      begin
        send_narrow_b(2'b01, AxiRespOkay, 1'b0);
        send_narrow_b(2'b00, AxiRespSlverr, 1'b0);
      end
      begin
        expect_wide_b(2'b01, AxiRespOkay, 1'b0);
        expect_wide_b(2'b00, AxiRespSlverr, 1'b0);
      end
    join
    ...
    $display("Checking halfword-sized shrinking read transaction");
    fork
      send_wide_ar(12'h122, 2'b10, 8'h01, 3'd1, 3'b100, 1'b1);
      expect_narrow_ar(12'h122, 2'b10, 8'h03, 3'd0, 3'b100, 1'b1);
    join

    fork
      begin
        send_narrow_r(2'b10, 8'h33, AxiRespSlverr, 1'b0, 1'b1);
        send_narrow_r(2'b10, 8'h44, AxiRespSlverr, 1'b0, 1'b1);
        send_narrow_r(2'b10, 8'h55, AxiRespSlverr, 1'b0, 1'b1);
        send_narrow_r(2'b10, 8'h66, AxiRespSlverr, 1'b1, 1'b1);
      end
      begin
        expect_wide_r(2'b10, 32'h44330000, AxiRespSlverr, 1'b0, 1'b1);
        expect_wide_r(2'b10, 32'h00006655, AxiRespSlverr, 1'b1, 1'b1);
      end
    join

    $display("Checking multi-beat read transaction that is not narrowed");
    fork
      send_wide_ar(12'h121, 2'b01, 8'h01, 3'd0, 3'b101, 1'b0);
      expect_narrow_ar(12'h121, 2'b01, 8'h01, 3'd0, 3'b101, 1'b0);
    join

    fork
      begin
        send_narrow_r(2'b01, 8'h22, AxiRespOkay, 1'b0, 1'b0);
        send_narrow_r(2'b01, 8'hBB, AxiRespOkay, 1'b1, 1'b0);
      end
      begin
        expect_wide_r(2'b01, 32'h00002200, AxiRespOkay, 1'b0, 1'b0);
        expect_wide_r(2'b01, 32'h00BB0000, AxiRespOkay, 1'b1, 1'b0);
      end
    join

    $display("Checking multiple read transactions inflight");
    fork
      begin
        send_wide_ar(12'h202, 2'b10, 8'h01, 3'd0, 3'b111, 1'b0);
        send_wide_ar(12'h204, 2'b11, 8'h00, 3'd1, 3'b111, 1'b0);
      end
      begin
        expect_narrow_ar(12'h202, 2'b10, 8'h01, 3'd0, 3'b111, 1'b0);
        expect_narrow_ar(12'h204, 2'b11, 8'h01, 3'd0, 3'b111, 1'b0);
      end
    join
