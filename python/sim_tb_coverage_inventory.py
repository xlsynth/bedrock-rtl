...
COMPOSITE_DIRECT_BENCH_PREFIXES = {
    ...
    "//flow/rtl:br_flow_burst_mux_fixed": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_burst_mux_fixed_stable": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_burst_mux_lru": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_burst_mux_lru_stable": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_burst_mux_rr": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_burst_mux_rr_stable": ("br_flow_mux_sim_test_tools_suite",),
    ...
    "//flow/rtl:br_flow_mux_fixed": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_mux_fixed_stable": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_mux_lru": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_mux_lru_stable": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_mux_rr": ("br_flow_mux_sim_test_tools_suite",),
    "//flow/rtl:br_flow_mux_rr_stable": ("br_flow_mux_sim_test_tools_suite",),
