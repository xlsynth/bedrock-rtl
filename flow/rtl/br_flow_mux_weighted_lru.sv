...
// Bedrock-RTL Flow-Controlled Multiplexer (Weighted Least-Recently-Used)
//
// Combines weighted least-recently-used (WLRU) arbitration with data path multiplexing.
// Grants a single request at a time with WLRU priority.
...
module br_flow_mux_weighted_lru #(
...
endmodule : br_flow_mux_weighted_lru
