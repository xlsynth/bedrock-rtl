...
// Bedrock-RTL Stable Round-Robin Flow Burst Mux Testbench

module br_flow_burst_mux_rr_stable_tb;
  ...
  initial begin
    ...
    @(posedge clk);
    #1;
    check_output(8'hc2, 1'b1, "round-robin should select flow two next");

    @(negedge clk);
    push_valid[2] = 1'b0;
    @(posedge clk);
    #1;
    check_output(8'ha0, 1'b1, "remaining flow should drain");
...
endmodule : br_flow_burst_mux_rr_stable_tb
