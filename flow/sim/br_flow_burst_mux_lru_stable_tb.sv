...
// Bedrock-RTL Stable Least-Recently-Used Flow Burst Mux Testbench

module br_flow_burst_mux_lru_stable_tb;
  ...
  initial begin
    ...
    @(posedge clk);
    #1;
    check_output(8'ha0, 1'b1, "flow zero should be least recently used next");
...
endmodule : br_flow_burst_mux_lru_stable_tb
