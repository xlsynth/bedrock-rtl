...
// Bedrock-RTL Least-Recently-Used Flow Mux Testbench

module br_flow_mux_lru_tb;
  ...
  initial begin
    ...
    push_valid = 3'b111;
    #1;
    check_transfer(3'b001, 8'h10, "LRU should initialize at flow zero");

    @(posedge clk);
    #1;
    check_transfer(3'b010, 8'h21, "flow one should become least recently used");
    ...
    pop_ready = 1'b1;
    #1;
    check_transfer(3'b010, 8'h21, "LRU state should hold through a stall");
    ...
    push_valid[0] = 1'b1;
    #1;
    check_transfer(3'b100, 8'h32, "flow two should become least recently used");

    @(posedge clk);
    @(negedge clk);
    push_valid[2] = 1'b0;
    #1;
    check_transfer(3'b001, 8'h10, "flow zero should become least recently used again");
