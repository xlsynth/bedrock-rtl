...
// Bedrock-RTL Fixed-Priority Flow Burst Mux Testbench

module br_flow_burst_mux_fixed_tb;
  ...
  initial begin
    ...
    push_valid[1] = 1'b0;
    #1;
    check_transfer(3'b001, 8'ha0, 1'b1, "fixed priority should select flow zero next");
...
endmodule : br_flow_burst_mux_fixed_tb
