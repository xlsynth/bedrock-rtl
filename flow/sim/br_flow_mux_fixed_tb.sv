...
// Bedrock-RTL Fixed-Priority Flow Mux Testbench

module br_flow_mux_fixed_tb;
  ...
  initial begin
    ...
    push_valid = 3'b111;
    #1;
    check_transfer(3'b001, 8'h10, "lowest-index flow should win");
    ...
    pop_ready = 1'b0;
    #1;
    check_transfer(3'b000, 8'h21, "next flow data should be visible while stalled");

    @(posedge clk);
    #1;
    check_transfer(3'b000, 8'h21, "second flow data should remain visible while stalled");
    @(negedge clk);
    pop_ready = 1'b1;
    #1;
    check_transfer(3'b010, 8'h21, "second flow should route after first drains");

    @(posedge clk);
    @(negedge clk);
    push_valid[1] = 1'b0;
    #1;
    check_transfer(3'b100, 8'h32, "third flow should route after second drains");
...
endmodule : br_flow_mux_fixed_tb
