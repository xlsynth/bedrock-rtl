...
// Bedrock-RTL Round-Robin Flow Burst Mux Testbench

module br_flow_burst_mux_rr_tb;
  ...
  initial begin
    ...
    push_valid[1] = 1'b0;
    #1;
    check_transfer(3'b100, 8'hc2, 1'b1, "round-robin should select flow two next");

    @(posedge clk);
    @(negedge clk);
    push_valid[2] = 1'b0;
    #1;
    check_transfer(3'b001, 8'ha0, 1'b1, "remaining flow should drain");
...
endmodule : br_flow_burst_mux_rr_tb
