...
// Bedrock-RTL Stable Round-Robin Flow Mux Testbench

module br_flow_mux_rr_stable_tb;
  ...
  initial begin
    ...
    @(posedge clk);
    #1;
    check_output(8'h21, "round-robin should advance to flow one");
    ...
    @(posedge clk);
    #1;
    check_output(8'h32, "round-robin should advance to flow two");

    @(negedge clk);
    push_valid[2] = 1'b0;
    @(posedge clk);
    #1;
    check_output(8'h10, "round-robin should wrap to flow zero");
...
endmodule : br_flow_mux_rr_stable_tb
