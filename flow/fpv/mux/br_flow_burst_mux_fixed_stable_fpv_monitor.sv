...
// Bedrock-RTL Flow-Controlled Stable Burst Multiplexer (Fixed-Priority)

`include "br_asserts.svh"
`include "br_fv.svh"

module br_flow_burst_mux_fixed_stable_fpv_monitor #(
...
bind br_flow_burst_mux_fixed_stable br_flow_burst_mux_fixed_stable_fpv_monitor #(
    .NumFlows(NumFlows),
    .Width(Width),
