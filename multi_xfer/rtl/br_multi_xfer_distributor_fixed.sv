...
// Bedrock-RTL Multi-Transfer Interface Distributor (Fixed Priority)
//
...
// fixed-priority arbitration. If there are fewer ready flows than
...
module br_multi_xfer_distributor_fixed #(
  ...
  br_multi_xfer_distributor_core #(
      ...
      .grant_ordered,
      .grant_count,
      // Not used for fixed-priority arbitration
