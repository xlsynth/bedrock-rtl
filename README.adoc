...
image::https://github.com/xlsynth/bedrock-rtl/actions/workflows/ci.yml/badge.svg?branch=main["main branch CI tests", link="https://github.com/xlsynth/bedrock-rtl/actions/workflows/ci.yml"]
