...
[![main](https://github.com/xlsynth/bedrock-rtl/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/xlsynth/bedrock-rtl/actions/workflows/ci.yml)
