...
Bazel can also run Yosys synthesis sweeps to provide quick generic and ASAP7-mapped PPA signals.
Run `bazel run //python/ppa:generate_ppa` to refresh link:PPA.md[] and link:PPA_ASAP7_RVT_TT.md[] from all public RTL sweep targets.
