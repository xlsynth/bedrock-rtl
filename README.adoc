...
image:https://img.shields.io/github/actions/workflow/status/xlsynth/bedrock-rtl/ci.yml?branch=main[CI,link="https://github.com/xlsynth/bedrock-rtl/actions/workflows/ci.yml"]
