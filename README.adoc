...
image:https://img.shields.io/github/issues/xlsynth/bedrock-rtl/bug?label=open%20bugs[open bugs,link="https://github.com/xlsynth/bedrock-rtl/issues?q=is%3Aissue%20state%3Aopen%20label%3Abug"]
